    ...
    constructor(conversationState, userState, dialog) {
        ...
        this.onMembersAdded(async (context, next) => {
            ...
            const card = CardFactory.heroCard(
                'Welcome to Github AI Chatbot!',
                'I can teach you about Git and Github. My knowledge sources are from Github docs (version: Free, Pro and Team). Ask away any question on your mind about Git or Github, or choose the options below to start!',
            ...
            for (let cnt = 0; cnt < membersAdded.length; cnt++) {
                if (membersAdded[cnt].id !== context.activity.recipient.id) {
                    ...
                    else await context.sendActivity({ attachments: [card] });
                }
            }
        ...
        const cardActions = [
            {
                ...
                title: 'Quickstart',
                value: 'Quickstart',
                image: 'https://via.placeholder.com/20/C0C0C0?text=Q',
                imageAltText: 'Q'
            },
            {
                type: ActionTypes.PostBack,
                title: 'Using Git',
                value: 'Using Git',
                image: 'https://via.placeholder.com/20/C0C0C0?text=U',
                imageAltText: 'U'
            },
            {
                type: ActionTypes.PostBack,
                title: 'Glossary',
                value: 'Glossary',
                image: 'https://via.placeholder.com/20/C0C0C0?text=G',
                imageAltText: 'G'
            }
        ];
